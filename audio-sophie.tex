...
\end{tabular}
\caption{Comparison of sensitivity and specificity for thresholds of F1 with men and women separate and combined. M, male; F, female; C, combined; A, apnoeic; B, benign; Sens, sensitivity (\%); Spec, specificity (\%).}
...
\end{tabular}
\caption{Regression analysis for AHI in events/h and first formant frequency (F1) in hertz. AHI computed at F1 = 470 Hz. Ideally predicted AHI = 10 events/h.}
...
\end{tabular}
\caption{Results of P-values of t-test between formants of snore and breath sounds.}
...
Sola-Soler&2012&23&13&Multiclass&Bayes&100&83.182.6&100\\ \bottomrule
\end{tabular}
