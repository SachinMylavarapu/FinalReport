...
\subsection{Scoring of Apnoeas R\&K vs. AASM}
...
\end{tabular}
\caption{Sound Intensity measures for subjects with apnoeic Snoring (RDI $\geq$ 10) and non-apnoeic snoring (RDI \textless\ 10) ~\cite{wilson1999snoring}.}
\label{table:wilson}
\end{table}
\subsection{Formants}
...
\end{tabular}
\caption{Bilateral significance in Mann Whitney U test to contrast population difference ~\cite{sola2003spectral}.}
...
\toprule
Type&AHI&Data size (train ; test)&Threshold of F1&Sens&Spec\\ \midrule
M:A&52.8 $\pm$ 24.7&720 ; 240&\multirow{2}{*}{545}&\multirow{2}{*}{83}&\multirow{2}{*}{92}\\ 
M:B&5.3 $\pm$ 3.5&180 ; 60&&&\\ 
F:A&23.6 $\pm$ 15.1&180 ; 60&\multirow{2}{*}{298}&\multirow{2}{*}{100}&\multirow{2}{*}{95}\\ 
F:B&3.4 $\pm$ 3.2&120 ; 40&&&\\ 
C:A&46.9 $\pm$ 25.7&900 ; 300&\multirow{2}{*}{470}&\multirow{2}{*}{88}&\multirow{2}{*}{82}\\ 
C:B&4.6 $\pm$ 3.4&300 ; 100&&&\\ \bottomrule
\end{tabular}
\caption{Comparison of sensitivity and specificity for thresholds of F1 with men and women separate and combined. M, male; F, female; C, combined; A, apnoeic; B, benign; Sens, sensitivity (\%); Spec, specificity (\%) ~\cite{ng2008could}.}
...
\toprule
Regression&Equations&$R^{2}$&Predicted AHI/h\\ \midrule
...
\end{tabular}
\caption{Regression analysis for AHI in events/h and first formant frequency (F1) in hertz. AHI computed at F1 = 470 Hz. Ideally predicted AHI = 10 events/h ~\cite{ng2008could}.}
...
\end{tabular}
\caption{Results of P-values of t-test between formants of snore and breath sounds ~\cite{yadollahi2009formant}.}
...
\caption{Bispectrums of common apnoeic and benign snores ~\cite{ng2007bispectral}.}
...
\begin{figure}[h]
\centering 
\includegraphics[width=0.3\textwidth]{drawings/ng2007fig6}
...
As has been shown a number of features can be used successfully to differentiate obstructive sleep apnoea sufferers from simple snorers with sub-band energy analysis and multiclass analysis performing the best, as can be seen from Table ~\ref{table:audio}. There were three ways the signals were classified: regression, K-means clustering and Bayes classifiers. Bayes classifiers and K-means clustering consistently outperformed regression classifiers. These are types of machine learning, although not the only types to be used for the classification of signals used in the diagnosis of OSA. Other types of machine learning used include: Hidden Markov Models used by Rossow et al to classify EEG signals ~\cite{rossow2011automatic}; Support Vector Machines used by Gederi and Clifford to classify images ~\cite{gederi2012fusion}; and neural networks used by Roberts and Tarassenko to classify EEG ~\cite{roberts1992new}. Given the success of machine learning in the cases shown, even with very small training and testing sets, this will be the focus of the next stage of our work. 

\begin{table}[h]
\centering
\begin{tabular}{l c c c l l c c c c}
\toprule
Author&Year&OSA&SS&Analysis&Classification&Sens&Spec&PPV&NPV\\ \midrule
Perez-Padilla&1993&9&10&Prominant Peaks&&&&&\\ 
Fiz&1996&10&7&Prominant Peaks&&&&&\\ 
Perez-Padilla&1993&9&10&Power Ratio&&&&&\\ 
Hara&2006&46&12&Power Ratio&&&&&\\ 
Van Brunt&1997&51&18&Sound Intensity&&93&25&51.6&80.6\\ 
Wilson&1999&682&261&Sound Intensity&Regression&&&&\\ 
Sola-Soler&2003&8&8&Formants&&&&&\\ 
Ng&2008&30&10&Formants&Regression&88&82&&\\ 
Yadollahi&2009&15&&Formants&K-means clustering&&&&\\ 
Causoglu&2007&12&18&Sub-band Energy&Regression&89.3&95.9&94.9&90.6\\ 
Azarbarzin&2010&13&7&Sub-band Energy&K-means clustering&94.8&96.3&95.8&95.3\\ 
Ng&2007&9&7&Bispectral&&&&&\\ 
Ng&2008&30&10&Wavelet&&&&&\\ 
Ng&2009&30&10&Wavelet&Regression&85&90.7&&\\ 
Ben Israel&2012&90&&Multiclass&Bayes&87&80&&\\ 
Sola-Soler&2012&23&13&Multiclass&Regression&91.3&53.8&67.4&85.5\\ 
Sola-Soler&2012&23&13&Multiclass&Bayes&100&83.1&82.6&100\\ \bottomrule
\end{tabular}
\caption{Study Statistics based on an AHI \textgreater\ 15 threshold. OSA, number of OSA sufferers in the study; SS, number of simple snorers in the study; Sens,sensitivity (\%); Spec, specificity (\%); NPV, negative predictive value (\%); PPV, positive predictive value (\%).}
\label{table:audio}
\end{table}
